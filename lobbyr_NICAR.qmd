...
Remember it's on lobbyists to divulge what and who they were lobbying – to there's no exact science. No silver bullet to get every disclosure. The key is to try and find the most common terms. Here's something I [used for a story we did about the](https://news.bloombergtax.com/daily-tax-report/business-groups-raced-to-rid-gop-spending-bill-of-revenge-tax) "revenge tax"
...
#And we're not tidying this, so it's the full structured API response
